                                        ...
                                        <div class="accordion" id="accordionExample">
                                                        ...
                                                        <div class="middle">
                                                            <div class="multi-range-slider my-2">
                                                                <input type="range" id="input_left" name="harga_min"
                                                                    class="range_slider" min="0" max="1000000"
                                                                    value="250000" onmousemove="left_slider(this.value)">
                                                                <input type="range" id="input_right" class="range_slider"
                                                                    name="harga_max" min="0" max="1000000"
                                                                    value="750000" onmousemove="right_slider(this.value)">
                                                                <div class="slider">
                                                                    <div class="track"></div>
                                                                    <div class="range"></div>
                                            ...
                                            <div class="card ">
                                                <div class="card-bodys">
                                                    <div
                                                        class="shop__sidebar__tags d-flex justify-content-center align-items-center">
