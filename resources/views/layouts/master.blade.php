                            ...
                            @forelse ($notif as $row)
                                <li class="px-3 py-2 d-flex flex-row justify-content-between align-items-center"
                                    ...
                                    <button class="btn" data-bs-dismiss="false" id="butonnotid{{ $row->id }}"
                                        onclick="deleteNotif(this, {{ $row->id }})"><i class="bi bi-x"></i></button>
                                </li>
                            @empty
        ...
        <div class="container">
            <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 pt-5">
                ...
                <div class="col mb-3">
                    <h5>Help</h5>
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Customer
                                Support</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Delivery
                                Details</a></li>
                ...
                <div class="col mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-body-secondary">Manage
                                Deliveries</a></li>
                        <li class="nav-item mb-2"><a href="#"
