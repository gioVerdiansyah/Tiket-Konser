...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    .spin{
        font-weight:bold;
        color: #00d60b; /* Atur warna teks agar kontras dengan latar belakang */
    }
    .spin before{
        content: ""; /* Menambahkan konten pseudo-element */
        display: block;
        position: absolute;
        top: 0;
        left: 0;
        right: 0;
        bottom: 0;
        border: 1px solid black; /* Mengatur border tipis */
        z-index: -1; /* Mengatur z-index agar border ada di belakang teks */
    }
      .bolder {
        text-align: center;
                        ...
                        <div class="card-body">
                            <div class="d-flex ">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    <button class="bittin hover" id="generatePdf" onclick="generatePDF('{{ $i }}')">Tiket
                                        Anda</button>
                                    </div>
                                    <div class="wrapper ">
                                    <p class="m-0 p-0">
                                        <strong style="color: rgb(231, 57, 188); text-decoration: underline;  cursor: pointer;" data-toggle="modal"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="big-wrapper">
                        ...
                        <div class="list-transaction">
                          ...
                          <span class="value">#MK1213234</span>
                        </div>
                        <div class="list-transaction">
                        ...
                        <div class="list-transaction">
                          ...
                          <span class="value">BCI</span>
                        </div>
                        <div class="list-transaction">
                          <span class="type">Fraud Status</span>
                          <span class="value">iki pisan ora ngerti</span>
                        </div>
                        <div class="list-transaction ">
                          <span class="type">Gross Amount</span>
                          <span class="value">opo iku gross emon</span>
                        </div>
                        <div class="list-transaction">
                          <span class="type">Masked Card</span>
                          <span class="value">Ra Paham</span>
                        </div>
                        <div class="list-transaction">
                ...
                <div class="big-wrapper">
                    <div class="wrapper-transaction new-background">
                        <h5 class="title-wrapper" id="exampleModalLabel">Detail Transaksi</h5>
                    <div class="list-transaction">
                        <span class="type">Tiket 1</span>
                        <span class="value">Konser A, Tanggal 10 Oktober 2023</span>
                    </div>
                    <div class="list-transaction">
                        <span class="type">Tiket 2</span>
                        <span class="value">Konser B, Tanggal 15 Oktober 2023</span>
                    </div>
                </div>
                </div>
            </div>
