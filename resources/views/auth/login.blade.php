        ...
        <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
            ...
            <form action="{{ route('login') }}" method="POST" class="login100-form validate-form">
                ...
                <span class="login100-form-title p-b-5">
                    ...
                    <p style="color: #fff;font-size:20px">Silahkan <a href="/register" style="color: #C10C99;font-size:20px;">Register Disini!</a></p>
                </span>
                ...
                <div class="wrap-input100 mb-5">
                    ...
                    <input class="input100" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="" required autocomplete="email" autofocus placeholder="Masukkan email anda">
