            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form class="login100-form validate-form">
                    <span class="login100-form-title p-b-5">
                        ...
                        <p style="color: #fff;font-size:20px">Silahkan <a href="#" style="color: #C10C99;font-size:20px">Login Disini!</a></p>
                    </span>
                    
                    <br><br>
                    
                    <div class="wrap-input100 validate-input mb-5" data-validate="Email di perlukan dengan contoh nama@gmail.com">
                        <span class="label-input100">Email</span>
                        <input class="input100" type="text" name="email" placeholder="Enter your email address">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Isi dengan Nama Lengkap Anda">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Silahkan Isi Password!">
                        ...
                        <input class="input100" type="password" name="pass" id="password" placeholder="Enter your Password">
                        <span class="focus-input100"></span>
                    </div>
                    <div class="wrap-input100 validate-input" data-validate="Isi Ulang Passwordd Anda!">
                        <span class="label-input100">Confirm Password</span>
                        <input class="input100" type="password" name="repeat-pass" id="confirm-password" placeholder="Confirm your Password">
                        <span class="focus-input100"></span>
                    </div>
